...
const _hoisted_1$5 = /* @__PURE__ */ createBaseVNode("h1", null, "JSONView", -1);
...
const _hoisted_1$4 = /* @__PURE__ */ createBaseVNode("h1", null, "JSONDump", -1);
...
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("h1", null, "User Display...", -1);
...
const __default__$4 = defineComponent({
  ...
  props: ["content"],
  mounted() {
    let users = JSON.parse(this.content);
    users.forEach((user) => {
      if (this.users[user.role] === void 0) {
        this.users[user.role] = [];
        this.displayRole[user.role] = false;
      }
      this.users[user.role].push(user);
    });
...
const _sfc_main$4 = defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        _hoisted_1$3,
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.users, (userList, roleName) => {
          return openBlock(), createElementBlock("div", { key: roleName }, [
            createBaseVNode("h2", {
              onClick: ($event) => _ctx.displayRole[roleName] = !_ctx.displayRole[roleName]
            }, [
              createTextVNode(toDisplayString(roleName) + " ", 1),
              _ctx.displayRole[roleName] ? (openBlock(), createElementBlock("span", _hoisted_3$1, "<")) : (openBlock(), createElementBlock("span", _hoisted_4, ">"))
            ], 8, _hoisted_2$3),
            (openBlock(true), createElementBlock(Fragment, null, renderList(userList, (user) => {
              return withDirectives((openBlock(), createElementBlock("div", {
                ...
                [vShow, _ctx.displayRole[roleName]]
              ]);
            }), 128))
          ]);
        }), 128))
...
const _hoisted_1$2 = /* @__PURE__ */ createBaseVNode("h1", null, "Domains", -1);
...
const _hoisted_1$1 = /* @__PURE__ */ createBaseVNode("h1", null, "Environment Variables", -1);
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.settings, (value, key) => {
          return openBlock(), createElementBlock("div", { key }, [
            createTextVNode(toDisplayString(key) + " : " + toDisplayString(value), 1),
            _hoisted_2$1
          ]);
        }), 128))
      ], 64);
...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", null, "Addons...", -1);
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.addons, (addon) => {
          return openBlock(), createElementBlock("div", {
            ...
            createBaseVNode("a", {
              href: addon.web_url
            }, toDisplayString(addon.addon_service.name), 9, _hoisted_2),
...
var axios$1 = axios;
class Heroku {
  constructor(uri = "https://api.heroku.com", token = "ee9e57b7-7c86-445e-995e-28267e46b4a2") {
  ...
  async loadBaseData() {
    this.teams = {};
    const teamsP = this.apiFetch("/teams", []);
    const appsP = this.apiFetch("/apps", []);
    const [teams, apps] = await Promise.all([teamsP, appsP]);
    teams.data.forEach((team) => {
      team["ids"] = { team: team["id"], teamName: team.name };
      team["sub"] = [];
      team["nodeType"] = "team";
      team["title"] = team["name"];
      this.teams[team.name] = team;
    });
    apps.data.forEach((app2) => {
      const teamName = app2.team.name;
      app2["nodeType"] = "app";
      app2["ids"] = { ...this.teams[teamName].ids, app: app2["id"], appName: app2["name"] };
      app2["title"] = teamName + " > " + app2["name"];
      if (!this.teams[teamName]["sub"]) {
        this.teams[teamName]["sub"] = [];
      }
      this.teams[teamName]["sub"].push(app2);
    });
  ...
  async apiFetch(feature, ids) {
    feature = feature.replace(/\{(.+?)_id\}/g, (m, label) => {
      return ids[label];
    });
    return axios$1.get(
      this.uri + feature,
...
const herokuInstance = new Heroku();
...
const __default__ = defineComponent({
  components: {
    JSONView: _sfc_main$6,
    JSONDump: _sfc_main$5,
    UserDisplay: _sfc_main$4,
    Domains: _sfc_main$3,
    EnvironmentVariables: _sfc_main$2,
    Addons: _sfc_main$1
  },
  data() {
    return {
...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(_ctx.componentType), { content: _ctx.contentJSON }, null, 8, ["content"]);
    };
  }
});
var main = "";
